...
CREATE TABLE `ebook`  (
                          ...
                          `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL
                              COMMENT 'name',
                          `category1_id` bigint NULL DEFAULT NULL COMMENT 'category1_id',
                          `category2_id` bigint NULL DEFAULT NULL COMMENT 'category2_id',
                          `description` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'description',
                          `cover` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL
                              COMMENT 'cover',
                          `doc_count` int NULL DEFAULT 0 COMMENT 'doc_count',
                          `view_count` int NULL DEFAULT 0 COMMENT 'view_count',
                          `vote_count` int NULL DEFAULT 0 COMMENT 'vote_count',
                          `deleted` int NULL DEFAULT 0 COMMENT 'deleted',
                          `update_time` datetime NULL DEFAULT NULL COMMENT 'update_time',
                          PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'name' ROW_FORMAT = DYNAMIC;
